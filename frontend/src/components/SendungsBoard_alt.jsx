        ...
        <NeueSendungSuper
          ...
          onSave={async (sendungData) => {
            try {
              ...
              // 🔍 TRANSPORT DEBUG - Was kommt wirklich an?
console.log('🔍 DEBUG sendungData:', {
  transport_type: sendungData.transport_type,
  transportArt: sendungData.transportArt,
  transportart: sendungData.transportart, // Klein geschrieben?
  vonFlughafen: sendungData.vonFlughafen,
  nachFlughafen: sendungData.nachFlughafen
});

// 🔧 TRANSPORT FIX - Alle Varianten prüfen
const finalTransportType = sendungData.transport_type || 
  (sendungData.transportArt === 'luftfracht' ? 'AIR' :
   sendungData.transportart === 'luftfracht' ? 'AIR' :  // Klein geschrieben testen
   sendungData.transportArt === 'seefracht' ? 'SEA' :
   sendungData.transportArt === 'lkw' ? 'TRUCK' : 'AIR');

console.log('🔧 FINALE TRANSPORTART:', finalTransportType);
